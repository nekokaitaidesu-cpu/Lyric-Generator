...
const STYLE_CONFIGS: {
...
}[] = [
  {
    id: 'yururi',
    label: 'ゆるりスタイル',
    subLabel: 'OPTION A  //  LO-FI / DREAM POP',
    desc: '放課後の教室みたいな　ふわっとした空気感。\nアコギとやわらかいボーカルで教科書を溶かす。',
    accent: COLORS.skyBlue,
  },
  {
    id: 'norinori',
    label: 'ノリノリスタイル',
    subLabel: 'OPTION B  //  J-POP / SYNTH POP',
    desc: '体育の授業みたいに　テンション高め。\nシンセとアップテンポで教科書を踊らせる。',
        ...
        {selected && (
          <View style={styles.selectedInfo}>
            ...
            <Text style={[
              ...
              { color: selected === 'yururi' ? COLORS.skyBlue : COLORS.yellow },
            ]}>
