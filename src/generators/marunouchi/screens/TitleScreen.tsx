...
export default function TitleScreen({ title, onUpdate, onNext, onBack }: Props) {
  // Parse initial words from title if possible, otherwise generate fresh
...
const styles = StyleSheet.create({
  ...
  wordText: { fontSize: 14, color: COLORS.neonYellow, fontWeight: '700' },
